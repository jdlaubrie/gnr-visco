...
E_gnd = 0.25
nu_gnd = 0.49
prestretch_circ = lambda_t
prestretch_long = lambda_z
# fibre properties
k1_fib = 0.40
k2_fib = 3.5
angle_fib = 44.0
prestretch_fib = lambda_f
# remodeling properties
tau_fibre = time_fibre      # x3 -> 90-days
growth_fibre = growth_gral
...
all_faces = part1.faces.getByBoundingCylinder(
                center1=(0,0,-1.0), center2=(0,0,1.0), radius=1.1*r_outer)
...
#----------------------------------------------------------------#
# cells are made all along the circumference initially, the we have to cut
...
material1_name = 'ground'
model1.Material(name=material1_name)
material1 = model1.materials[material1_name]
#material1.UserMaterial(mechanicalConstants=(E_gnd, nu_gnd, tau_gnd, prestretch_circ, prestretch_long))
material1.UserMaterial(mechanicalConstants=(E_gnd, nu_gnd, k1_fib, k2_fib, angle_fib,
                        prestretch_circ, prestretch_long, prestretch_fib,
                        fraction_mat, fraction_fib, tau_fibre, growth_fibre))
material1.Depvar(n=23)

# section membrane
model1.HomogeneousSolidSection(name='wall_section', material=material1_name)

# section assignment, BOTTOM_SURFACE, TOP_SURFACE
part1.SectionAssignment(region=part1.sets['body'], sectionName='wall_section',
...
#        smooth=SOLVER_DEFAULT, data=((0.0, 0.0), (time1, 1.0), (time2, 1.0), (time2+0.5*period3, factor), (time3, 1.0), (time4, 1.0)))
...
# create job
mdb.Job(name='cylinder1_2d', model='aortic_wall', description='', type=ANALYSIS,
...
model1.keywordBlock.insert(69, """** \n** PREDEFINED FIELDS\n** \n** Name: initial_stretch Type: Solution""")
model1.keywordBlock.insert(70, """*Initial Conditions, type=SOLUTION, user""")

# write input file
mdb.jobs['cylinder1_2d'].writeInput()
